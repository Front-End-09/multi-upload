...
function renderUploadedFiles() {
    ...
    uploadedFiles.forEach((file, index) => {
        ...
        const deleteButtonHTML = `
          <button type="button" onclick="deleteButton('${index}','${fileName}');" type="button" class="text-red-500 hover:text-red-700 focus:outline-none">
    ...
    window.deleteButton = function(index, fileName) {
        // Remove the clicked file from the uploadedFiles array
